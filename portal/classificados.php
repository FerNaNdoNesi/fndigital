...
<title>Bem - Vindo ao Portal Orange</title>
...
<div id="wrap">
	<div id="header">
		<div id="header-content">
			<h1 id="logo"><a href="classificados.php" title="Portal Orange">Portal<span class="orange">Orange</span></a></h1>
...
<script language="JavaScript" type="text/javascript">
    ...
    <div id="categorias">
        	<table>
	        <tr>
            	<td class="principal"><img src="img/categorias/classificados.png"/><br/>Categorias Disponiveis</td>
            </tr>
            </table>
        <?php 
			categorias();
